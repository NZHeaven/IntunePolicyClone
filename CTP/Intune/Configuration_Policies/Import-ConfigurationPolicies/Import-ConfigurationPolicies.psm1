...
Function Import-ConfigurationPolicies() {
    param(
    ...
    if (!(Test-Path "$FolderPath")) {
        ...
        Write-Host "Folder Path for JSON folder doesn't exist..." -ForegroundColor Red
    ...
    Get-ChildItem $FolderPath -Filter *.json | ForEach-Object {
        try {
            ...
            Write-Error "Error Importing Device Configuration Policy '$DisplayName' - Continuing"
        }
    }
}

Export-ModuleMember -Function Import-ConfigurationPolicies